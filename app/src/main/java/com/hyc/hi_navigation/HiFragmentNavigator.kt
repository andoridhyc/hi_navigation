...
import com.hyc.hi_navigation.HiFragmentNavigator.Destination
...
public open class HiFragmentNavigator(
    private val context: Context,
    private val fragmentManager: FragmentManager,
    private val containerId: Int
) : Navigator<HiFragmentNavigator.Destination>() {
    ...
    public constructor(fragmentNavigator: Navigator<out Destination>) :
        ...
        public constructor(navigatorProvider: NavigatorProvider) :
                this(navigatorProvider.getNavigator(HiFragmentNavigator::class.java))
